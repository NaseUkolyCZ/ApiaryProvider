...
let githubLink = "http://github.com/NaseUkolyCZ/ApiaryProvider"

// Specify more information about your project
let info =
  [ "project-name", "ApiaryProvider"
    "project-author", "Update Author in build.fsx"
    "project-summary", "Type provider for Apiary.io http://fsprojects.github.io/ApiaryProvider"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/ApiaryProvider" ]
